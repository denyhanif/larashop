    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-6">
                <form action="{{ route('books.index') }}" class="">
                    ...
                    <div class="input-group">
                        <input type="text" name="keyword" placeholder="Filter by title" class="form-control" value="{{ Request::get('keyword') }}">
            ...
            <div class="col-md-6">
                ...
                <li class="nav-item">
                    <a class="nav-link {{Request::get('status') == 'publish' ? 'active' : '' }}" href="{{route('books.index', ['status' => 'draft'])}}">Draft</a>
                </li>
                <li class="nav-item">
